                        ...
                        <div class="card m-3"   >
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">(21) 2424-2424</li>
                                    </ul>
                                </div>
            </div>
                        </div>
                            ...
                            <div class="card m-3"  >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">(11) 2424-2424</li>
                                        </ul>
                                    </div>
            </div>
                            </div>
                            ...
                            <div class="rol">
                                <div class="card m-3"  >
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">Avenida Pía, Natal</li>
                                                <li class="list-group-item">10 &ordm; andar</li>
                                                <li class="list-group-item">Centro</li>
                                                <li class="list-group-item">(71) 2424-2424</li>
                                            </ul>
                                        </div>
            </div>
                                </div>
